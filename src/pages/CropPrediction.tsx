  ...
  if (result) {
    return (
      <div className="pb-20 min-h-screen">
        <PageHeader title="Prediction Result" subtitle="AI-powered crop recommendation" />
    ...
    <div className="pb-20 min-h-screen">
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <Card className="p-6">
            <h3 className="font-semibold mb-4 text-primary">Soil Nutrients (kg/ha)</h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  id="nitrogen"
                  type="number"
                  {...register("nitrogen", { required: true, min: 0, max: 200 })}
                  placeholder="0-200"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  id="phosphorus"
                  type="number"
                  {...register("phosphorus", { required: true, min: 0, max: 200 })}
                  placeholder="0-200"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  id="potassium"
                  type="number"
                  {...register("potassium", { required: true, min: 0, max: 200 })}
                  placeholder="0-200"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  type="number"
                  step="0.1"
                  {...register("temperature", { required: true, min: 0, max: 50 })}
                  placeholder="0-50"
                />
              </div>
